          ...
          </ul>
          {
            !user ? (
              <div className="flex items-center gap-2">
                <Link to="/login">
                <Button variant='outline' className="rounded-full px-4 py-2 border-gray-300 hover:border-gray-400 shadow-sm">
                  Login
                </Button>
                </Link>
                <Link to="/signup">
                <Button className='bg-[#6a38c2] hover:bg-[#5b30a6] rounded-full px-4 py-2 text-white shadow-md'>
                  Signup
                </Button>
                </Link>
              </div>
                ...
                <PopoverContent className="w-80">
                  ...
                  <div className="flex flex-col my-2 text-gray-600">
                    <div className="flex w-fit items-center gap-2 cursor-pointer">
                      <User2 />
                      <Button variant="link"><Link to='/'>View Profile</Link></Button>
                    </div>
                    <div className="flex w-fit items-center gap-2 cursor-pointer">
                      <LogOut />
